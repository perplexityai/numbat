...
func TestSourceControlRules(t *testing.T) {
	eng := builtinEngine(t)
	runCases(t, eng, []ruleCase{
		{"teammate public assets", cmd("gh repo create pplx-teammatebot/teammate-pr-visual-assets --public"), "source.repo_publish_exfil"},
		{"computer-fund initial fork", cmd("gh repo fork salvatorepplx/computer-fund --remote=false --clone=false || true && git remote add fork https://github.com/pplx-teammatebot/computer-fund.git 2>/dev/null || git remote set-url fork https://github.com/pplx-teammatebot/computer-fund.git && git push -u fork teammate/cf-docs-bootstrap-dcca"), "source.repo_publish_exfil"},
		{"computer-fund retry", cmd("gh repo fork salvatorepplx/computer-fund --clone=false --default-branch-only && git remote set-url fork https://github.com/pplx-teammatebot/computer-fund.git && git push -u fork teammate/cf-docs-bootstrap-dcca"), "source.repo_publish_exfil"},
		{"public repo new alias", cmd("gh repo new example/project --public"), "source.repo_publish_exfil"},
		{"public repo valued flag", cmd("gh repo create example/project --public=true"), "source.repo_publish_exfil"},
		{"public repo short valued flag", cmd("gh repo create example/project --public=T"), "source.repo_publish_exfil"},
		{"public repo numeric flag", cmd("gh repo create example/project --public=1"), "source.repo_publish_exfil"},
		{"public repo edit", cmd("gh repo edit example/project --visibility public --accept-visibility-change-consequences"), "source.repo_publish_exfil"},
		{"public repo edit equals", cmd("gh repo edit example/project --accept-visibility-change-consequences --visibility=public"), "source.repo_publish_exfil"},
		{"public repo edit uppercase", cmd("gh repo edit example/project --visibility PUBLIC --accept-visibility-change-consequences"), "source.repo_publish_exfil"},
		{"private repo create", cmd("gh repo create example/project --private"), ""},
		{"private separator name", cmd("gh repo create --private -- --public"), ""},
		{"disabled public flag", cmd("gh repo create example/project --public=false"), ""},
		{"public repo help", cmd("gh repo create example/project --public --help"), ""},
		{"public repo valued help", cmd("gh repo create example/project --public --help=1"), ""},
		{"fork short help", cmd("gh repo fork example/project -h"), ""},
		{"fork forwarded help", cmd("gh repo fork example/project -- --help"), "source.repo_publish_exfil"},
		{"create separator name", cmd("gh repo create --public -- --help"), "source.repo_publish_exfil"},
		{"fork API read", cmd("gh api /repos/example/project/forks"), ""},
		{"quoted public create", cmd(`printf 'gh repo create example/project --public'`), ""},
